<?php 
   $title=array('','工作监督意见','添加,刷新,删除,批删除');
   $schcmd='工作类别=PC:list(RendaJiandu),日期=PDATE:date,关键字=keywords';
   $coumnName='code,type,content,apartment,supervise,time,progress,suggest,press';
